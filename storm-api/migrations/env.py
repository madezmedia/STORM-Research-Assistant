...
from main import Base, ContentBrief, GeneratedContent, ResearchData
...
config.set_main_option("sqlalchemy.url", "postgresql+asyncpg://user:password@localhost/storm_db")
